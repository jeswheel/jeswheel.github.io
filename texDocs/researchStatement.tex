...
State-space models are appealing because they allow researchers to incorporate mechanisms that reflect our current scientific understanding of the system.
...
% In this case, the state-space model is a convinient approach to fitting a model rather than being of direct interest itself.
...
To rectify this, I propose a random restart algorithm that frequently results in higher likelihoods than standard alternative \cite{wheelerARMA}.
