...
{\bf PhD in Statistics} \hfill {\textit{2020--May 2025}}
...
\begin{reflist}
    ...
    \item Wheeler, J., Ionides, E. L. (2024). Likelihood Based Inference for ARMA models. {\it arXiv:2310.01198}. {\it In review at The American Statistician}.

    \item Wheeler, J., Abkemeier, A. A., Ionides, E. L. (2024). Iterating Marginalized Bayes Maps for Likelihood Maximization. {\it In preperation for the Journal of the American Statistical Association}.

    \item Bret\'o, C., Wheeler, J., King, A., Ionides, E. L. (2024). panelPomp: Analysis of Panel Data via Partially Observed Markov Processes in R. {\it arXiv:2410.07934}. {\it In review at The R Journal}.

    \item Yang, B., Wheeler, J., King, A., Duffy, M., Ionides, E. L. (2024). Mechanistic Models for Panel Data: Analysis of Ecological Experiments with Four Interacting Species. {\it In preparation for Journal of the American Statistical Association, Case Studies}.
...
\begin{teachinglsit}
    ...
    \item \textbf{Stats 415}, {\it Lab Instructor} \hfill (Introduction to Statistical Learning)
