...
\begin{reflist}
    ...
    % \item Yang, B., Wheeler, J., King, A., Duffy, M., Ionides, E. (2024) Mechanistic Models for Panel Data: Analysis of Ecological Experiments with Four Interacting Species.
...
\begin{reflist}
  ...
  \item Bo Yang. Analysis of Panel Data via Mechianistic Models in a PanelPOMP Framework. Honors thesis, 2023.
...
\vspace{2mm}
\noindent \textbf{Peer Reviews}: PLoS computation biology, Nature Communications
