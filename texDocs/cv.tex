...
\begin{reflist}
    ...
    \item Wheeler, J., Abkemeier, A. A., Ionides, E. L. (2024). Iterating Marginalized Bayes Maps for Likelihood Maximization. {\it In preperation}.
...
\begin{reflist}
  ...
  \item Peter Yang. {\it Ongoing}. Applications of Partially Observed Markov Processes with phylogenetic data.
