...
contact:
  - text: Email
    href: jesse.wheeler@usu.edu
---

- **Email**: jesse.wheeler@usu.edu
- **Office Location**: Ray B West 421 

## About Me

I am an Assistant Professor in the Department of Mathematics and Statistics at Utah State University.
I earned my Ph.D. in Statistics from the University of Michigan in 2025, under the mentorship of [Edward Ionides](https://ionides.github.io/), and spent one year as an assistant professor of statistics at Idaho State University.
...
My primary application areas include infectious disease modeling, and fish populations in fresh water fisheries.
If you are interested in learning more about my research or are interested in collaborating, do not hesitate to reach out to me via email (jesse.wheeler@usu.edu).
...
- [panelPomp](https://panelPomp-org.github.io): This R package on [CRAN](https://cran.r-project.org/web/packages/panelPomp/index.html) is used for inference of [Panel POMP models](https://doi.org/10.1080/01621459.2019.1604367). As associated software paper was recently accepted at The R Journal ([10.32614/RJ-2025-009](https://doi.org/10.32614/RJ-2025-009)). 
